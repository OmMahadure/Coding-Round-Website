...
app.get('/api/admin/dashboard', async (req, res) => {
  ...
  try {
    ...
    const dashboardData = allUsers.map(user => {
      // Find the most recent test result for this user (in case of duplicates)
      ...
      if (results) {
        // Use the actual structure being sent from the frontend
...
// NEW: Debug endpoint to see all test results
...
// NEW: Debug endpoint to see email matching
